...
func newRunCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&oFlags.model, "model", "", "override the harness/agent model for this run (alias such as opus/sonnet/haiku, a model id, or provider/id on pi and codex; also $FULLSEND_MODEL)")
