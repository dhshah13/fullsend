...
| Content capture (Level 3) | Text, reasoning, tool calls and tool results (correlating ids) | Same, minus tool results — pi's parser does not emit them yet | Same, minus ids and tool results — codex's parser emits neither |
